        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              {/* Facebook */}
              {contact.facebook && (
                <a href={contact.facebook.startsWith('http') ? contact.facebook : `https://${contact.facebook}`} target="_blank" rel="noopener noreferrer" title="Facebook" className="w-10 h-10 rounded-full bg-[#1877F2] border border-[#1877F2] flex items-center justify-center text-white hover:bg-[#166FE5] hover:shadow-[0_4px_15px_rgba(24,119,242,0.4)] transition-all duration-300 group">
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor" className="group-hover:scale-110 transition-transform">
              ...
              {/* TikTok */}
              {contact.tiktok && (
                <a href={contact.tiktok.startsWith('http') ? contact.tiktok : `https://${contact.tiktok}`} target="_blank" rel="noopener noreferrer" title="TikTok" className="w-10 h-10 rounded-full bg-black border border-black flex items-center justify-center text-white hover:bg-slate-800 hover:shadow-[0_4px_15px_rgba(0,0,0,0.4)] transition-all duration-300 group">
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor" className="group-hover:scale-110 transition-transform">
