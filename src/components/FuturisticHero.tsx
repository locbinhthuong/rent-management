  ...
  return (
    <div className="relative w-full min-h-[100svh] md:min-h-[90vh] flex flex-col items-center justify-center overflow-hidden py-24 md:py-0">
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-4 flex flex-col items-center mt-4 md:mt-[-10vh]">
        ...
        >
          <h1 className="font-space text-4xl sm:text-5xl md:text-7xl font-extrabold text-slate-900 tracking-tight mb-3 md:mb-4 drop-shadow-2xl leading-tight">
        ...
        >
          <div className="flex flex-col md:grid md:grid-cols-2 gap-x-6">
            ...
            {/* Row 1: Keyword */}
            <div className="flex items-center gap-4 py-3 md:py-4 border-b border-slate-200/80 md:col-span-2 group">
              ...
              <div className="flex flex-col w-full flex-1">
                ...
                <input 
                  ...
                  className="bg-transparent text-slate-900 font-semibold text-[15px] outline-none placeholder-slate-500 w-full"
            ...
            {/* Row 2: City */}
            <div className="flex items-center gap-4 py-3 md:py-4 border-b border-slate-200/80 group">
            ...
            {/* Row 3: District */}
            <div className={`flex items-center gap-4 py-3 md:py-4 border-b border-slate-200/80 group ${!city ? 'opacity-50' : ''}`}>
            ...
            {/* Row 5: Price */}
            <div className="flex items-center gap-4 py-3 md:py-4 border-b border-slate-200/80 group md:border-b-0">
