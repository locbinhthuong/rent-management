...
export default function LocusLogo({ className = "", width = "100%", height = "100%" }: LocusLogoProps) {
  return (
    <div className={`flex flex-col items-center justify-center ${className}`}>
      ...
      >
        ...
        {/* Text: LOCUS */}
        <text x="200" y="260" fontFamily="sans-serif" fontSize="42" fontWeight="900" fill="#1d5681" textAnchor="middle" letterSpacing="4">LOCUS</text>
        
        {/* Text: HOME */}
        <text x="200" y="285" fontFamily="sans-serif" fontSize="22" fontWeight="700" fill="#25b6d6" textAnchor="middle" letterSpacing="8">HOME</text>
      </svg>
    </div>
  );
}
