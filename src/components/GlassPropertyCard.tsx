      ...
      >
        <Link href={`/p/${post._id}`} className="block h-full w-full">
          ...
          <div className="relative aspect-[4/3] w-full overflow-hidden">
            ...
            <div className="absolute top-3 left-3 bg-slate-900/60 backdrop-blur-md px-3 py-1 rounded-full text-xs font-semibold text-cyan-300 border border-white/10 shadow-[0_0_10px_rgba(6,182,212,0.3)]">
              {post.property_type || 'Phòng trọ'}
            </div>
            {post.is_verified && (
              <div className="absolute top-3 right-3 bg-emerald-500/20 backdrop-blur-md px-2 py-1 rounded-full flex items-center justify-center border border-emerald-500/50 shadow-[0_0_10px_rgba(16,185,129,0.3)]">
