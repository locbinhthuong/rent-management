  ...
  return (
    <main className="min-h-screen bg-slate-50 pt-8 pb-20 flex flex-col items-center justify-center">
      <div className="max-w-md mx-auto px-4 sm:px-6 text-center">
        ...
        <Link href="/" className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-indigo-600 text-white font-bold rounded-xl hover:bg-indigo-700 transition-colors">
