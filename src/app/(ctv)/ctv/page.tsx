  ...
  return (
    <div className="min-h-screen bg-slate-50 flex">
      ...
      <main className="flex-1 flex flex-col h-screen overflow-y-auto">
        ...
        <div className="p-4 md:p-8 pb-20 md:pb-8 space-y-6 md:space-y-8 max-w-5xl mx-auto w-full">
          {/* Quick Action */}
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            {posts.length === 0 ? (
              ...
              <div className="divide-y divide-slate-100">
                {posts.map((post) => (
                  <div key={post._id.toString()} className="p-5 flex flex-col md:flex-row md:items-center justify-between hover:bg-slate-50 transition gap-4">
                    <div>
